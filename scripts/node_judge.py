...
DIG_TEXT = {
    ("红海", "小"): "红海，决心小：停在这里。全文 0。快判里那 3 篇很近的论文已经够。不写深的近邻表，也不钻进论文里找缝。",
    ("蓝海", "小"): "蓝海，决心小：全文 0，再核对最像的 1 到 2 篇题目和摘要。不像就收一个小题目。不钻六问。不许换个场景把它说成新的。",
    ("看不清", "小"): "还看不清，决心小：只补题目和摘要，凑到能判为止，最多 8 篇。不要读全文。",
    ("红海", "中"): "红海，决心中：全文只读最强的 1 篇。三问答完就停。这一篇还看不出有没有盖住你，最多再加 1 篇，到 2 篇为止。不许换场景，也不许收成它没做的那一小块。",
    ("蓝海", "中"): "蓝海，决心中：全文只读最强的 1 篇，不够再加 1 篇。近邻表三栏写完，三问答完就停。",
    ("看不清", "中"): "还看不清，决心中：先用题目和摘要点明最强的几篇，判成红海或蓝海，再按中档只读 1 到 2 篇全文。",
    ("红海", "大"): "红海，决心大：全文读能杀死这句话的那几篇，通常 3 到 5 篇，六问答完就停。不要读满 12 或 20 才算做完。缝必须是它自己没回答的问题。六问都闭合还没有这个问题，才允许停。不许换名、换场景、收成补集。",
    ("蓝海", "大"): "蓝海，决心大：同样读 3 到 5 篇最强近邻的全文，把六问答完，确认这片空是真的，不是没看见近邻。",
    ("看不清", "大"): "还看不清，决心大：先读到能判红海或蓝海，再把六问答完。全文仍停在 3 到 5 篇。不要用看不清当作继续搜的理由。",
}
FAST_ENOUGH = (
    "快判够了就可以停。已经有 3 篇很近的正式论文做了那个想法，就是红海，不必再搜。"
    "还没有，就凑满 8 篇实质相关的正式论文，只看题目和摘要。"
    "然后再看 5 个题目，判断不变就停。这一步全文是 0。"
    "100 篇是不许再横向搜的天花板，不是判断要读满的数量。"
)
PAGE_QUESTIONS = {
    "ocean": {
        "type": "choice",
